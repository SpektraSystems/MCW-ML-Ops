...
3. Click on upload files button and go to **C:/MCW-MLOps/MCW-MLOps** directory and select **Register Model.ipynb** and then select **MCW-MLOps** as the target folder. Select **Upload**.
