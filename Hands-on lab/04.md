...
3. Select **Job** to monitor the detailed status of the build pipeline execution.
    ...
    ![In the Jobs screen, the Job that was selected in the previous step is expanded displaying multiple steps. To the right a summary of the run is displayed.](media/azure-24.png 'Monitor Build Pipeline Details')
