...
3.  Click on upload files butoon and go to **C:/MCW-MLOps/notebooks** directory and select **Test Deployment.ipynb** and then select **MCW-MLOps** folder as the target folder. Select **Upload**.
